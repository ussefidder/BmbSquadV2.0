	...
	<div class="sp-template sp-template-event-venue">
		...
		<table class="sp-data-table sp-event-venue">
			...
			<?php if ( $show_maps && $latitude != null && $longitude != null ): ?>
				<tbody>
					<?php if (splash_is_layout("af") || splash_is_layout("sccr") && $address != null ) { ?>
						<tr class="sp-event-venue-address-row">
							<td><?php if(splash_is_layout("af")) : ?><i class="stm-icon-pin"></i><?php else: ?><i class="fa fa-location-arrow" aria-hidden="true"></i><?php endif; ?><?php echo sanitize_text_field($address); ?></td>
						</tr>
					<?php } ?>
					<tr class="sp-event-venue-map-row">
						<td><?php sp_get_template( 'venue-map.php', array( 'meta' => $meta ) ); ?></td>
					</tr>
					<?php if (splash_is_layout("bb") && $address != null ) { ?>
						<tr class="sp-event-venue-address-row">
