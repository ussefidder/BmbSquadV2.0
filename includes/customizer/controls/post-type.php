<?php
if ( ! class_exists( 'STM_Customizer_Post_Type_Control' ) ) {

	class STM_Customizer_Post_Type_Control extends WP_Customize_Control {
		...
		public function render_content() {
			...
			$post_types[] = esc_html__( '--- Default ---', 'splash' );
